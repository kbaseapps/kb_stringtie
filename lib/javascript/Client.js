...
function kb_stringtie(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_stringtie_app = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_stringtie.run_stringtie_app",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_stringtie.status",
