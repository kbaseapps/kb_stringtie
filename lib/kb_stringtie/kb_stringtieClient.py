...
class kb_stringtie(object):
    ...
    def run_stringtie_app(self, params, context=None):
        ...
        :param params: instance of type "StringTieInput" (required params:
           ...
           coverage min_isoform_abundance: minimum isoform abundance merge:
           set transcript merge mode ref:
           http://ccb.jhu.edu/software/stringtie/index.shtml?t=manual) ->
           structure: parameter "alignment_ref" of type "obj_ref" (An X/Y/Z
           style reference), parameter "expression_object_name" of String,
           parameter "workspace_name" of String, parameter "merge" of type
           "boolean" (A boolean - 0 for false, 1 for true. @range (0, 1)),
           parameter "run_matrix_count" of type "boolean" (A boolean - 0 for
           false, 1 for true. @range (0, 1)), parameter "num_threads" of
           Long, parameter "junction_base" of Long, parameter
           "junction_coverage" of Double, parameter "disable_trimming" of
           type "boolean" (A boolean - 0 for false, 1 for true. @range (0,
           1)), parameter "min_locus_gap_sep_value" of Long, parameter
           "ballgown_mode" of type "boolean" (A boolean - 0 for false, 1 for
           true. @range (0, 1)), parameter "skip_reads_with_no_ref" of type
           "boolean" (A boolean - 0 for false, 1 for true. @range (0, 1)),
