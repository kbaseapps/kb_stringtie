...
class kb_stringtieTest(unittest.TestCase):
    ...
    def prepare_data(cls):
        ...
        save_object_params = {
            'id': workspace_id,
            'objects': [{'type': 'KBaseMetagenomes.AnnotatedMetagenomeAssembly',
                         'data': ama_data,
                         'name': 'test_mini_AMA'}]
        }
    ...
    # def test_run_stringtie_app_alignment_with_AMA(self):
    #     input_params = {
