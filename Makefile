...
SERVICE_CAPS = kb_stringtie
SPEC_FILE = kb_stringtie.spec
URL = https://kbase.us/services/kb_stringtie
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
TARGET_TESTS = .  # ex ./kb_stringtie_ci_tests.py:kb_stringtie_ciTest.test_assembly_ref
...
build-test-script:
	...
	echo 'cp -R /kb/module/lib/kb_stringtie/ /kb/module/work/kb/module/lib/' >> $(TEST_DIR)/$(TEST_SCRIPT_NAME) 
